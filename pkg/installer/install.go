...
func (in *Installer) installStorageOSCluster() error {
	...
	if in.stosConfig.Spec.Install.StorageOSClusterNamespace != "" && in.stosConfig.Spec.Install.StorageOSClusterNamespace != in.stosConfig.Spec.Install.StorageOSOperatorNamespace {
